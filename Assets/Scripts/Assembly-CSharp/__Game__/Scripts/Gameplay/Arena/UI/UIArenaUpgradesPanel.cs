...
{
	public class UIArenaUpgradesPanel : MonoBehaviour
	{
		[SerializeField]
		...
		[Inject]
		private void Inject(GameplayUpgradesSystem gameplayUpgradesSystem, ArenaUpgradesPresenter arenaUpgradesPresenter, UnitCardSystem unitCardSystem, RarityConfig rarityConfig)
		{
		}
