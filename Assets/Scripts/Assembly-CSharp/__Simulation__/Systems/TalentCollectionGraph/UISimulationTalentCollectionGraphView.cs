...
{
	public class UISimulationTalentCollectionGraphView : MonoBehaviour
	{
		[CompilerGenerated]
		private sealed class _003CDisableLayoutGroupsNextFrame_003Ed__9 : IEnumerator<object>, IEnumerator, IDisposable
		{
			...
			public UISimulationTalentCollectionGraphView _003C_003E4__this;
		...
		[SerializeField]
		private UISimulationTalentCollectionSnapshot _uiSimulationTalentCollectionSnapshotPrefab;
		...
		private static Dictionary<string, int> BuildTalentOrder(List<SimulationSnapshot> snapshots)
		{
			return null;
		}
	}
